...
<div class="max-w-lg mx-auto">
    <div class="mb-6">
        ...
        <h2 class="text-2xl font-bold text-slate-900">Tambah Pelanggan</h2>
        <p class="text-xs text-slate-500 mt-1">Isi data pelanggan baru di bawah ini.</p>
    </div>
        ...
        <form action="{{ route('pelanggan.store') }}" method="POST" class="space-y-5">
            ...
            <div>
                ...
                <div class="grid grid-cols-2 gap-3">
                    <label class="relative cursor-pointer">
                        <input type="radio" name="type" value="retail" {{ old('type','retail') === 'retail' ? 'checked' : '' }} class="peer sr-only">
                    ...
                    <label class="relative cursor-pointer">
                        <input type="radio" name="type" value="reseller" {{ old('type') === 'reseller' ? 'checked' : '' }} class="peer sr-only">
            ...
            <div>
                ...
                <textarea name="notes" rows="3"
                          class="w-full border border-slate-200 rounded-xl px-4 py-2.5 text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-brand-500/30 focus:border-brand-500 resize-none"
            ...
            <div class="flex gap-3 pt-2">
                ...
                <button type="submit" class="flex-1 py-2.5 text-sm font-bold text-white bg-brand-dark hover:bg-brand-800 rounded-xl shadow transition-all">Simpan Pelanggan</button>
            </div>
        </form>
    </div>
</div>
